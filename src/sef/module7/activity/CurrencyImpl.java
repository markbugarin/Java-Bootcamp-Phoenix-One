...
public class CurrencyImpl implements Currency {
	...
	public String toString() {
		return "CurrencyImpl [value=" + value + ", denomination=" + denomination + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (Float.floatToIntBits(value) != Float.floatToIntBits(other.value) && Objects.equals(denomination.getName(), other.getDenomination().getName()))
			return false;
		return true;
	}
}
